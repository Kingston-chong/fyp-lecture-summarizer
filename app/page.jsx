...
const HOMEPAGE_MODEL_PROVIDERS = [
  {
    ...
    description:
      "Flagship OpenAI models known for nuanced reasoning, strong writing, and reliable performance across a wide range of academic tasks.",
  ...
  },
  {
    ...
    description:
      "Highly efficient open-source models that excel at technical and STEM content — ideal for math, code, and data-heavy subjects.",
  ...
  },
  {
    ...
    description:
      "Google's latest model family offering a massive context window, fast response variants, and deep analytical capability for long or complex documents.",
      ...
      <section className="hero">
        <div className="container" style={{ position: "relative", zIndex: 2 }}>
          ...
          <p className="hero-sub">
            Upload PDFs, slides, Word docs or spreadsheets - Slide2Notes distils
            them into sharp summaries, interactive notes, quiz questions and
            presentation slides.
          </p>
            ...
            <div className="hero-mock-card">
              <div className="mock-topbar">
                ...
                <div className="mock-title">
                  slide2notes.vercel.app/summary/3
                </div>
              </div>
              <div className="mock-body">
                <div className="mock-sidebar">
                  ...
                  <div className="mock-sb-label" style={{ marginTop: "12px" }}>
                    Uploads
                  </div>
                  <div className="mock-sb-item">
                    <div
                      className="mock-sb-dot"
                      style={{ background: "rgba(245,166,35,.5)" }}
                    />
                    DB_Notes.pdf
                  </div>
                  <div className="mock-sb-item">
                ...
                <div className="mock-main">
                  ...
                  <div className="mock-chat-row">
                    <span className="mock-placeholder">
                      Ask anything about this summary...
                    </span>
          ...
          <div className="how-grid">
            <div>
              ...
              <h2 className="section-h2 reveal reveal-delay-1">
                Four steps from <em>upload</em> to insight
              </h2>
            ...
            <div className="how-visual reveal reveal-delay-2">
              ...
              <div className="how-vis-card">
                <div className="how-vis-title">
                  Database Normalization - Student Mode
                </div>
                <div className="how-vis-lines">
                  <div
                    className="how-vis-line accent"
                    style={{ width: "90%" }}
                  />
                  <div className="how-vis-line" style={{ width: "100%" }} />
                  <div className="how-vis-line" style={{ width: "82%" }} />
                  <div
                    className="how-vis-line amber"
                    style={{ width: "65%", marginTop: "6px" }}
                  />
                  <div className="how-vis-line" style={{ width: "100%" }} />
      ...
      <section className="features" id="features">
        <div className="container">
          <div className="features-head">
            ...
            <h2 className="section-h2 reveal reveal-delay-1">
              Everything a student <em>needs</em>
            </h2>
            <p className="section-p reveal reveal-delay-2">
              From raw lecture slides to exam-ready notes - Slide2Notes covers
              the full study workflow in one place.
            </p>
          </div>
          ...
          <div className="features-grid">
            {[
              [
                ...
                "PDF, PPTX, DOCX, XLSX, TXT, CSV and Markdown - upload any mix of files and process them together in a single summary.",
              ],
              [
                "amb",
                "AI chat on summaries",
                "Ask follow-up questions directly against your summarized content. The AI has full context - no copy-pasting required.",
                "amber-card",
              ],
              [
                "tel",
                "Slide generation",
                "Turn any summary into a structured PPTX presentation with custom templates, font sizes and text density settings.",
                "teal-card",
              ],
              [
                "ind",
                "Quiz creation",
                "Auto-generate multiple-choice quiz questions from your summary to test comprehension or prepare for exams.",
              ],
              [
                "amb",
                "PDF export",
                "Download your summary and chat history as a clean, well-formatted PDF - ready to share with classmates or save for revision.",
                "amber-card",
              ],
              [
                "tel",
                "Full history",
                "Every summary is saved to your account. Revisit past sessions, re-use previously uploaded files, or continue an old chat.",
                "teal-card",
              ],
        ...
        <div className="container">
          <div className="formats-inner reveal">
            <div>
              ...
              <p
                className="section-p"
                style={{ fontSize: "14.5px", marginTop: "12px" }}
              >
                No converting, no reformatting. Upload the file exactly as you
                received it.
              </p>
            ...
            <div className="formats-right reveal reveal-delay-1">
              <div className="fmt-stat">
                <div className="fmt-stat-num">
                  <em>3</em>
                </div>
                <div className="fmt-stat-label">
                  AI providers to choose from - ChatGPT, DeepSeek and Gemini
                </div>
              </div>
              ...
              <div className="fmt-stat">
                ...
                <div className="fmt-stat-label">
                  Summary modes - Student (simplified) and Lecturer (detailed)
                </div>
              </div>
              <div className="fmt-divider" />
              <div className="fmt-stat">
                ...
                <div className="fmt-stat-label">
                  Documents you can upload and store in your personal library
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="models" id="models">
        <div className="container">
          <div className="models-head">
            ...
            <h2 className="section-h2 reveal reveal-delay-1">
              Models currently <em>offered</em>
            </h2>
          </div>
            ...
            {HOMEPAGE_MODEL_PROVIDERS.map((provider, idx) => (
              ...
              >
                <div className="model-head-row">
                  <div className={`model-logo ${provider.logoClass}`}>
                    {provider.logo}
                  </div>
                  <div>
                    <div className="model-name">{provider.name}</div>
                    <div className="model-ver">
                      {provider.versions.join(" · ")}
                    </div>
                  </div>
                </div>
                ...
                <div className="model-tags">
                  {provider.tags.map((tag) => (
                    <div key={tag} className="model-tag">
                      {tag}
                    </div>
                  ))}
                </div>
      ...
      <section className="cta">
        <div className="container">
          <div className="cta-box reveal">
            ...
            <p className="cta-p">
              Join students and lecturers who already use Slide2Notes to cut
              through dense material and get to the knowledge that matters.
            </p>
        ...
        <div className="container">
          <div className="footer-inner">
            ...
            <div className="footer-links">
              ...
              <a href="#">Terms</a>
              <a
                href="https://github.com/Kingston-chong/fyp-lecture-summarizer"
                target="_blank"
                rel="noreferrer"
              >
                GitHub
