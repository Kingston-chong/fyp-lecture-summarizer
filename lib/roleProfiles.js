...
const ROLE_PROFILES = {
  ...
  lecturer: {
    ...
    chatInstructions: [
      ...
      "When reference search is enabled, use inline [n] markers only for web and journal sources from the numbered list, and end with a ## References section for those sources only.",
