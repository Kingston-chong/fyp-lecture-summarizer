...
export const openApiSpec = {
  ...
  components: {
    ...
    schemas: {
      ...
      SummaryReferenceItem: {
        type: "object",
        properties: {
          id: { type: "integer" },
          marker: { type: "integer" },
          kind: { type: "string", enum: ["upload", "paper"] },
          title: { type: "string" },
  ...
  paths: {
    ...
    "/api/summary/{id}/references": {
      get: {
        tags: ["Summaries"],
        summary: "List academic and upload references for a lecturer summary",
        security: [{ sessionAuth: [] }],
        parameters: [
          {
            name: "id",
        ...
        responses: {
          "200": {
            description: "References fetched",
            content: {
              "application/json": {
                schema: {
                  type: "object",
                  properties: {
                    references: {
                      type: "array",
                      items: { $ref: "#/components/schemas/SummaryReferenceItem" },
                    },
                  },
                },
              },
    ...
    "/api/summary/{id}/references/{refId}": {
      patch: {
        tags: ["Summaries"],
        summary: "Update one summary reference",
        security: [{ sessionAuth: [] }],
        parameters: [
        ...
        responses: {
          "200": { description: "Updated; returns full references list" },
          "404": { description: "Not found" },
        },
      },
      delete: {
        tags: ["Summaries"],
        summary: "Delete one summary reference",
        security: [{ sessionAuth: [] }],
        parameters: [
          { name: "id", in: "path", required: true, schema: { type: "integer" } },
          { name: "refId", in: "path", required: true, schema: { type: "integer" } },
        ...
        responses: {
          "200": { description: "Deleted; returns remaining references" },
          "404": { description: "Not found" },
        },
      },
    },
